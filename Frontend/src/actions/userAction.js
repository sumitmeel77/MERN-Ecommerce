...
export const register = (userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`http://localhost:4000/api/user/register`, userData);
...
export const loadUser = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:4000/api/user/getDetail`);
...
export const forgotPassword = (email) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`http://localhost:4000/api/user/forgotPassword`, email, config);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`http://localhost:4000/api/admin/UserDetail/${id}`);
...
export const updateUser = (id, userData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `http://localhost:4000/api/admin/UpdateRole/${id}`,
      userData,
      config
    );
